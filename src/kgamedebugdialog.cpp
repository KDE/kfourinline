...
void KGameDebugDialog::initPlayerPage()
{
    ...
    connect(d->mPlayerList, &QListWidget::itemActivated, this, qOverload<QListWidgetItem *>(&KGameDebugDialog::slotUpdatePlayerData));
...
void KGameDebugDialog::initMessagePage()
{
    ...
    mMessageListHeader->setText(2, tr("Receiver"));
